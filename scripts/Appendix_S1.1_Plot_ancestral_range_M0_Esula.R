setwd("C:/Users/Bird_/Downloads/Esula_Manuscrito/New_Analysis/Simple_M0")
...
plot_fn = paste(fp, "output_esula_simple_M0/simple_M0.range.pdf",sep="")
tree_fn = paste(fp, "output_esula_simple_M0/anc_states.ase.tre", sep="")
label_fn = paste(fp, "output_esula_simple_M0/output_10000gen_simple_M0.state_labels.txt", sep="")
...
pp=plotAncStatesPie(t = ancstates, 
                    ...
                    tip_pie_size = 0.25,
                    pie_colors = c("#d95f02",	"#F94C10",	"#016A70",	"#00FF7F",	"#3457D5",	"#D4ECDD",	"#C5A880",	"#FF7272",	"#a6d85f",	"#D2D79F",	"#750050",	"#e7298a",	"#0E8388",	"#00FFFF",	"#783F04",	"#F4CCCC",	"#FFD523",	"#512B81",	"#CE2029",	"#394867",	"#99627A"),
                    node_pie_size = 0.25,
