# Plotting HiSSE Esula diversification rates
library(ggplot2)
source("Appendix_S4_multiplot.R")
data <- read.table("output_HiSSE_Esula_15000generaciones/HiSSE_Esula.log", header=TRUE)
...
pdf("5. Plot_HiSSE_diversification_Esula.pdf")
